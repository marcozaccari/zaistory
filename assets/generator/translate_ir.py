...
I tre passi:
    ...
    python translate_ir.py extract examples/metalhead.ir.json -o metalhead.prompts.json
    # (si traducono i valori, la struttura resta uguale)
    python translate_ir.py merge examples/metalhead.ir.json metalhead.prompts_en.json
    python translate_ir.py status examples/metalhead.ir.json
