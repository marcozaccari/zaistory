...
Uso:
    python extract_manifest.py examples/metalhead.ir.json -o out/manifest.json
    python extract_manifest.py examples/metalhead.ir.json --level anchors
    python extract_manifest.py examples/metalhead.ir.json --sample 6 -o out/sample.json
"""
